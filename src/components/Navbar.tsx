  ...
  return (
    <nav className={cn(
      ...
      <div className="flex items-center gap-[12px] sm:gap-[16px] md:gap-[24px]">
        ...
        <a href="https://soundcloud.com/arnav-b-779948090" aria-label="SoundCloud" className="transition-colors duration-300 text-white/60 hover:text-white" target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://in.pinterest.com/arnavbsss/" aria-label="Pinterest" className="transition-colors duration-300 text-white/60 hover:text-white" target="_blank" rel="noopener noreferrer">
